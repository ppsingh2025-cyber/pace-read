 ...
 *   Row 1 – Playback + speed: Back · Play/Pause · Next · WPM pill stepper
 *   Row 2 – Load + utility: Upload · Paste · Reset (hidden in focus mode)
 *
...
export default function Controls({
  ...
  return (
    <div className={styles.controls}>
      ...
      {/* ── Row 2: Load + utility (hidden in focus mode) ── */}
      {!focused && (
        <div className={styles.loadRow}>
          ...
          >
            ...
            <span className={styles.controlBtnLabel}>Reset</span>
          </button>
        </div>
      )}
