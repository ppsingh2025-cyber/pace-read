...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '#',  color: '#4a7a6a', title: 'Jump to any word',      desc: 'Click the word counter pill (e.g. 42% · w1,234 / 3000), type a word number and press Enter, or pick a percentage from the dropdown.' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '⊞',  color: '#4a5a6a', title: 'Focus mode',           desc: 'Tap ⊞ or the eye icon (👁) in the bottom bar to enter fullscreen — word and tick marks only, no UI. Tap the eye icon again or press Esc / F to exit.' },
